...
export interface S24LootPreviewPageProps {
...
export default function S24LootPreview(props: S24LootPreviewPageProps) {
  const { weapons, armor, cosmetics, mods, otherDefinitions } = props;
    ...
    <div className={s.root}>
      <div className={s.hero}>
        <div className={s.heroText}>
          ...
          <h1 className={s.pageTitle}>Salvation's Edge</h1>
        </div>
      </div>
